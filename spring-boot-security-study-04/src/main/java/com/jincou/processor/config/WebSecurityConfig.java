...
import com.jincou.processor.filter.ImageCodeFilter;
import com.jincou.processor.service.UserService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //开启登陆配置
        http.addFilterBefore(imageCodeFilter, UsernamePasswordAuthenticationFilter.class).authorizeRequests()
